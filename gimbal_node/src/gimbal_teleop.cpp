...
// get the console in raw mode                                                              
  ...
  //ROS_INFO("value: 0x%02X\n", c);
    ...
    switch(c)
    {
      ...
      if(yaw_mode==1)
      {
        if(last_c==KEYCODE_A) yaw_speed=+v_key_value;
        else 
        { 
        yaw_speed=0;
        }
      ...
      if(yaw_mode==1)
      {
        if(last_c==KEYCODE_D) yaw_speed=-v_key_value; 
        else 
        { 
        yaw_speed=0;
        }
      ...
      case KEYCODE_W:
        ...
        if(pitch_mode==1)
        {
          if(last_c==KEYCODE_W) pitch_speed=+v_key_value;
          else 
          { 
          pitch_speed=0;
          }
      ...
      case KEYCODE_S:
        ...
        if(pitch_mode==1)
        {
          if(last_c==KEYCODE_S) pitch_speed=-v_key_value;
          else 
          { 
          pitch_speed=0;
          }
